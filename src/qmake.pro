HEADERS		= 	callbacks.hpp init.hpp GraphicModelChess.hpp globals.hpp \
				utils/mathUtils.hpp shaders/shaders.hpp
				
SOURCES		=	project60337.cpp globals.cpp callbacks.cpp GraphicModelChess.cpp init.cpp models.cpp \
